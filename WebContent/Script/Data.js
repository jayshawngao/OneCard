...
var studentInfo = {
    ...
    changeStudentCateory: function (cateory, callback) {
        ajaxGet("/User/StudentInfo/Ashx/ChangeStudentCateory.ashx", { cat: cateory }, callback);
    },
    insertStudentLetterDetail: function (lid, detail, descript, callback) {
        detail = encodeURIComponent(detail);
        descript = encodeURIComponent(descript);
        ajaxGet("/User/StudentInfo/Ashx/InsertStudentLetterDetail.ashx", { lid: lid, detail: detail, descript: descript }, callback);
    },
    modifySystemMesgeStatus: function (smid, smtype, callback){
        ajaxGet("/User/StudentInfo/Ashx/ModifySystemMesgeStatus.ashx", { smid: smid, smtype: smtype }, callback);
    }
}

//在线图书馆，数据访问调用
var senateCenter = {
    modifyStudentBorrowStatus: function (sid, examtime, stype, callback) {
        ajaxGet("/User/SenateCenter/Ashx/ModifyStudentBorrowStatus.ashx", { sid: sid, examtime: examtime, stype: stype }, callback);
    },
    modifyStudentManageBookStatus: function (bid, stype, callback) {
        ajaxGet("/User/SenateCenter/Ashx/ModifyStudentManageBookStatus.ashx", { bid: bid, stype: stype }, callback);
    },
