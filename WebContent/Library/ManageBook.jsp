...
<body>
    ...
    <div class="morebt">
        <ul>
            ...
            <li><a class="tab1" href="<%=cp %>/Library/ManageBook.jsp">管理书籍</a></li>
...
<table>
<tr>
    <td>    <input type="button" id="button2" value="显示所有书籍" onclick="window.location=('<%=cp %>/BookServlet?method=all&flag=2')" class="input2" /></td>
    <td>    <input type="button" id="button2" value="添加书籍" onclick="window.location=('<%=cp %>/Library/InsertBook.jsp')" class="input2" /></td>
     <td>   <form name="form1" action="/OneCard/BookServlet" method="get">
     <input type="hidden"  name="method" class="input2" value="findByName"  /> 
      <input type="hidden"  name="flag" class="input2" value="2"  /> 
