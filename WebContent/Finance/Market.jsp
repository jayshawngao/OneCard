...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>
    ...
    <script src="<%=cp %>/Script/jquery-1.4.1.js" type="text/javascript"></script>
    <link href="<%=cp %>/Style/history.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <h2 class="mbx">
        ...
        <ul>
            ...
            <li><a class="tab1" href="<%=cp %>/Finance/Market.jsp">在线超市</a></li>
...
<table>
<tr>
    <td>    <input type="button" id="button2" value="显示所有商品" onclick="window.location=('<%=cp %>/CommodityServlet?method=all&flag=1')" class="input2" /></td>
