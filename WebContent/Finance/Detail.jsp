...
<% Commodity c=(Commodity)request.getAttribute("commodity");
...
<div class="cztable">
    <form name="form1" action="/OneCard/CommodityOrderServlet?id=${requestScope.commodity.id}&price=${requestScope.commodity.price}&method=order" method="post">
    <table width="65%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="right" >商品编号：</td>
            <td>${requestScope.commodity.id}&nbsp;</td>
                    <td rowspan="3"><div align="center"><a href="/OneCard/Finance/UploadPhoto.jsp?id=${requestScope.commodity.id}"><img id="pic_face"  height="160" width="120" title="上传图片" src="/OneCard/upload/images/${requestScope.commodity.photo}" style="padding:2px 2px 5px; border:1px #ddd solid;"></a></div>&nbsp;</td>
        
            
        </tr>
        <tr>
            <td align="right">名称：</td>
            <td>${requestScope.commodity.name}&nbsp;</td>
 
        </tr>

        <tr>
            <td align="right">价格：</td>
            <td>${requestScope.commodity.price}&nbsp;</td>
        ...
        <tr align="center">
            <td colspan="5" height="40">
                <div align="center">
                    ...
                    <input type="submit" id="button2" value="购买" onclick="return check()" class="input2" />
                </div>
            </td>
        </tr>
    </table>
